...
public class DensitySpacious {
    ...
    public static let ComponentButtonButtonLabelFontSize = 19
    ...
    /** This variable is in the SpaceScaling Collection. It was made to experiment with how scaling space could work across different content scaling / size / contrast themes. */
    public static let ComponentButtonButtonInlineSpace = 24
    /** This variable is in the SpaceScaling collection. It was made to experiment with how scaling space could work across different content scaling / size / contrast themes. */
    public static let ComponentButtonButtonStackSpace = 12
    ...
    public static let ComponentInputfieldInputFieldLabelFontSize = 19
