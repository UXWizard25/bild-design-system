...
public class BreakpointSportbildSm {
...
Apply this token to the main frame of page layouts. */
    public static let SemanticLayoutCanvasWidthSizeWeb = 390
...
Apply this token to the main frame of page layouts to simulate realistic vertical space. */
    public static let SemanticLayoutCanvasHeightSizeWeb = 844
    /** Common viewport width size based on the selected breakpoint.
Apply this token to the main frame of page layouts. */
    public static let SemanticLayoutCanvasWidthSizeApp = 390
    /** Common viewport height size based on the selected mode.
Apply this token to the main frame of page layouts to simulate realistic vertical space. */
    public static let SemanticLayoutCanvasHeightSizeApp = 844
...
Apply this token to the main frame of page layouts to simulate realistic minimum widths across responsive viewports. */
    public static let SemanticLayoutBreakpointsBreakpointMinWidthSize = 390
...
Apply this token to the main frame of page layouts to simulate realistic maximum widths across responsive viewports. */
    public static let SemanticLayoutBreakpointsBreakpointMaxWidthSize = 599
    ...
    public static let SemanticTypographyFontSizeDisplayDisplay1FontSize = 38
    /** This variable is used for the font size parameter of the Display2 text style. 36 - 36 - 42 - 64 */
    public static let SemanticTypographyFontSizeDisplayDisplay2FontSize = 34
    ...
    public static let SemanticTypographyFontSizeHeadlineHeadline1FontSize = 42
    /** This token is used on the headline2 text style's font size parameter. 40 - 40 - 48 - 64 */
    public static let SemanticTypographyFontSizeHeadlineHeadline2FontSize = 42
    ...
    public static let SemanticTypographyFontSizeHeadlineHeadline4FontSize = 21
    ...
    public static let SemanticTypographyFontSizeKickerKicker1FontSize = 20
    ...
    public static let SemanticTypographyFontSizeTitleTitle1FontSize = 24
    ...
    public static let SemanticTypographyLineHeightTitleTitle2LineHeight = 20.8
    ...
    public static let ComponentArticleArticleKickerFontSize = 20
    /** 40 - 40 - 72 - 100 - This variable uses the semantic variables headline2 for XS&SM, headline1 for MD&LG */
    public static let ComponentArticleArticleHeadlineFontSize = 42
    ...
    /** Tab labels font size remain constant at 16px across devices and breakpoints. This behavior can be seen on the Mein Konto page tabs for purchases and payment data. */
    public static let ComponentTabsAppsTabsLabelFontSize = 12
    /** Tab labels font size remain constant at 16px across devices and breakpoints. This behavior can be seen on the Mein Konto page tabs for purchases and payment data. */
    ...
    public static let ComponentTeaserATeaserATeaserHeadlineFontSize = 30
    ...
    public static let ComponentTeaserMQTeaserMQTeaserHeadlineFontSize = 21
    ...
    public static let ComponentTeaserQTeaserQuadHeadlineFontSize = 42
    ...
    public static let Component_DSysDocsDSysDocsWidthSize = 750
    ...
    public static let Component_DSysDocsMainContentStageSize = 750
