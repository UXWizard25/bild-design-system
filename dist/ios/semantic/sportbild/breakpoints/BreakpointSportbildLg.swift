...
public class BreakpointSportbildLg {
...
Apply this token to the main frame of page layouts to simulate realistic maximum widths across responsive viewports. */
    ...
    public static let SemanticTypographyFontSizeDisplayDisplay1FontSize = 114
    /** This variable is used for the font size parameter of the Display2 text style. 36 - 36 - 42 - 64 */
    public static let SemanticTypographyFontSizeDisplayDisplay2FontSize = 61
    /** This variable is used on the display3 font size parameter of the display3 text style. 28 - 28 - 32 - 40 */
    public static let SemanticTypographyFontSizeDisplayDisplay3FontSize = 38
    ...
    public static let SemanticTypographyFontSizeHeadlineHeadline1FontSize = 80
    /** This token is used on the headline2 text style's font size parameter. 40 - 40 - 48 - 64 */
    public static let SemanticTypographyFontSizeHeadlineHeadline2FontSize = 50
    /** This token is used on the headline3 text style's font size parameter. 28 - 28 - 36 - 40 */
    public static let SemanticTypographyFontSizeHeadlineHeadline3FontSize = 34
    ...
    public static let SemanticTypographyFontSizeKickerKicker1FontSize = 32
    ...
    public static let SemanticTypographyFontSizeKickerKicker3FontSize = 22
    ...
    public static let SemanticTypographyFontSizeKickerKicker4FontSize = 18
    ...
    public static let SemanticTypographyFontSizeSubheadlineSubheadline1FontSize = 26
    /** 22 - 22 - 22 - 28 -- html class stage-block-title__text css var --ressort-header-font-size(sm-md-lg) */
    public static let SemanticTypographyFontSizeTitleTitle1FontSize = 30
    ...
    public static let SemanticTypographyLineHeightBodyBodyLineHeight = 28.05
    ...
    public static let SemanticTypographyLineHeightTitleTitle2LineHeight = 26
    /** This variable is used in the quote text style line height parameter. */
    public static let SemanticTypographyLineHeightQuoteQuoteLineHeight = 26
    ...
    public static let ComponentArticleArticleKickerFontSize = 32
    /** 40 - 40 - 72 - 100 - This variable uses the semantic variables headline2 for XS&SM, headline1 for MD&LG */
    public static let ComponentArticleArticleHeadlineFontSize = 80
    /** CSS --article-figure-meta-font-size 16-16-18-18 */
    public static let ComponentArticleArticleImageCaptionFontSize = 15
    ...
    public static let ComponentArticleArticleImageSourceFontSize = 15
    ...
    public static let ComponentBreadcrumbBreadcrumbFontSize = 11
    /** 15 - 15 - 15 - 12 -- Breadcrumbs have a slightly larger font size on mobile devices compared to when they are rendered on larger desktop devices. */
    public static let ComponentBreadcrumbBreadcrumbLineHeight = 11
    ...
    public static let ComponentTeaserATeaserATeaserHeadlineFontSize = 50
    ...
    public static let ComponentTeaserMQTeaserMQTeaserHeadlineFontSize = 34
    ...
    public static let ComponentTeaserQTeaserQuadHeadlineFontSize = 80
