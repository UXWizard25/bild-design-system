...
public class ColorSportbildLight {
    ...
    public static let SemanticCoreCoreColorPrimary = UIColor(red: 0.039, green: 0.149, blue: 0.310, alpha: 1.000)
    ...
    public static let SemanticCoreCoreColorTertiary = UIColor(red: 0.031, green: 0.090, blue: 0.161, alpha: 1.000)
    ...
    public static let SemanticCoreCoreColorTertiaryConstant = UIColor(red: 0.031, green: 0.090, blue: 0.161, alpha: 1.000)
    ...
    public static let SemanticAttentionAccentColorPrimary = UIColor(red: 0.090, green: 0.271, blue: 0.510, alpha: 1.000)
    ...
    public static let SemanticAttentionAccentColorPrimaryConstant = UIColor(red: 0.090, green: 0.271, blue: 0.510, alpha: 1.000)
...
Behavior: Constant — identical value across modes for consistent interaction feedback. */
    public static let SemanticStateColorPrimaryActive = UIColor(red: 0.090, green: 0.271, blue: 0.510, alpha: 1.000)
...
Behavior: Dynamic — switches between dark and light values depending on mode. */
    public static let SemanticSurfaceSurfaceColorPrimaryInverse = UIColor(red: 0.031, green: 0.090, blue: 0.161, alpha: 1.000)
...
Behavior: Constant — identical across Light and Dark mode. */
    public static let SemanticSurfaceSurfaceColorPrimaryConstantDark = UIColor(red: 0.031, green: 0.090, blue: 0.161, alpha: 1.000)
...
Behavior: Dynamic — adapts brightness level based on mode for appropriate depth contrast. */
    public static let SemanticSurfaceSurfaceColorSecondary = UIColor(red: 0.969, green: 0.980, blue: 0.988, alpha: 1.000)
...
Behavior: Dynamic — switches between light and dark tertiary tones. */
    public static let SemanticSurfaceSurfaceColorTertiary = UIColor(red: 0.741, green: 0.788, blue: 0.859, alpha: 1.000)
...
Behavior: Dynamic — swaps values between modes for contrast preservation. */
    public static let SemanticSurfaceSurfaceColorTertiaryInverse = UIColor(red: 0.090, green: 0.271, blue: 0.510, alpha: 1.000)
...
Behavior: Dynamic — dark text in Light mode, light text in Dark mode. */
    public static let SemanticHeadingHeadlineColorPrimary = UIColor(red: 0.039, green: 0.149, blue: 0.310, alpha: 1.000)
...
Behavior: Constant — always light neutral to guarantee accessibility on dark backgrounds. */
    ...
    public static let SemanticTextTextColorAccent = UIColor(red: 0.090, green: 0.271, blue: 0.510, alpha: 1.000)
...
Behavior: Constant — maintains identical red tone across Light and Dark mode. */
    public static let SemanticTextTextColorAccentConstant = UIColor(red: 0.090, green: 0.271, blue: 0.510, alpha: 1.000)
...
Behavior: Dynamic — lighter gray in Light mode, darker neutral in Dark mode. */
    ...
    public static let ComponentButtonPrimaryButtonPrimaryBrandBgColorIdle = UIColor(red: 0.090, green: 0.271, blue: 0.510, alpha: 1.000)
    public static let ComponentButtonPrimaryButtonPrimaryBrandBgColorHover = UIColor(red: 0.039, green: 0.149, blue: 0.310, alpha: 1.000)
    ...
    public static let ComponentChipsChipsBgColorActive = UIColor(red: 0.090, green: 0.271, blue: 0.510, alpha: 1.000)
    ...
    public static let ComponentDropdownDropdownBgColorHover = UIColor(red: 0.969, green: 0.980, blue: 0.988, alpha: 1.000)
    public static let ComponentEmptiesEmptiesLogoColor = UIColor(red: 0.812, green: 0.831, blue: 0.851, alpha: 1.000)
    public static let ComponentEmptiesEmptiesBgColor = UIColor(red: 0.969, green: 0.980, blue: 0.988, alpha: 1.000)
    public static let ComponentFoldoutFoldoutLabelColorIdle = UIColor(red: 0.290, green: 0.322, blue: 0.349, alpha: 1.000)
    public static let ComponentFoldoutFoldoutLabelColorActive = UIColor(red: 0.090, green: 0.271, blue: 0.510, alpha: 1.000)
    public static let ComponentGalleryAppImageLightboxGalleryBgColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)
    public static let ComponentHeyHeyDrawerSurfaceColor = UIColor(red: 0.969, green: 0.980, blue: 0.988, alpha: 1.000)
    ...
    public static let ComponentKickerStandardKickerBgColorOnSurface = UIColor(red: 0.090, green: 0.271, blue: 0.510, alpha: 1.000)
    ...
    public static let ComponentMenuItemMenuItemBorderColorActive = UIColor(red: 0.039, green: 0.149, blue: 0.310, alpha: 1.000)
    ...
    public static let ComponentPaginationPaginationElementColorActive = UIColor(red: 0.090, green: 0.271, blue: 0.510, alpha: 1.000)
