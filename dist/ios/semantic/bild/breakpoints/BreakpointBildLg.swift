...
Apply this token to the main frame of page layouts to simulate realistic maximum widths across responsive viewports. */
    ...
    public static let SemanticTypographyFontSizeKickerKicker1FontSize = 30
    ...
    public static let SemanticTypographyFontSizeKickerKicker2FontSize = 24
    ...
    public static let SemanticTypographyFontSizeSubheadlineSubheadline1FontSize = 36
    ...
    public static let SemanticTypographyFontSizeTitleTitle2FontSize = 20
    /** 16 - 16 - 18 - 20 -- This variable is used for controlling the font size of the quote text style. */
    public static let SemanticTypographyFontSizeQuoteQuoteFontSize = 20
    ...
    public static let SemanticTypographyLineHeightBodyBodyLineHeight = 32
    ...
    public static let SemanticTypographyLineHeightTitleTitle2LineHeight = 22
    /** This variable is used in the quote text style line height parameter. */
    public static let SemanticTypographyLineHeightQuoteQuoteLineHeight = 22
    ...
    public static let ComponentAvatarAvatarLabelFontSize = 18
    ...
    public static let ComponentArticleArticleKickerFontSize = 30
    /** 40 - 40 - 72 - 100 - This variable uses the semantic variables headline2 for XS&SM, headline1 for MD&LG */
    public static let ComponentArticleArticleHeadlineFontSize = 100
    /** CSS --article-figure-meta-font-size 16-16-18-18 */
    public static let ComponentArticleArticleImageCaptionFontSize = 18
    /** this component level variable references the branding variables */
    public static let ComponentArticleArticleImageCaptionLineHeight = 24.75
    ...
    public static let ComponentArticleArticleImageSourceFontSize = 18
    ...
    public static let ComponentTeaserATeaserATeaserKickerFontSize = 24
    ...
    public static let ComponentTeaserATeaserATeaserHeadlineFontSize = 64
    ...
    public static let ComponentTeaserMQTeaserMQTeaserHeadlineFontSize = 40
    ...
    public static let ComponentTeaserQTeaserQuadHeadlineFontSize = 100
