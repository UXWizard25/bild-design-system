...
Apply this token to the main frame of page layouts to simulate realistic maximum widths across responsive viewports. */
    ...
    public static let SemanticTypographyFontSizeDisplayDisplay1FontSize = 72
    /** This variable is used for the font size parameter of the Display2 text style. 36 - 36 - 42 - 64 */
    public static let SemanticTypographyFontSizeDisplayDisplay2FontSize = 42
    /** This variable is used on the display3 font size parameter of the display3 text style. 28 - 28 - 32 - 40 */
    public static let SemanticTypographyFontSizeDisplayDisplay3FontSize = 32
    ...
    public static let SemanticTypographyFontSizeHeadlineHeadline1FontSize = 72
    ...
    public static let SemanticTypographyFontSizeHeadlineHeadline3FontSize = 36
    ...
    public static let SemanticTypographyFontSizeKickerKicker1FontSize = 22
    ...
    public static let SemanticTypographyFontSizeKickerKicker2FontSize = 22
    ...
    public static let SemanticTypographyFontSizeKickerKicker3FontSize = 18
    ...
    public static let SemanticTypographyFontSizeSubheadlineSubheadline1FontSize = 32
    ...
    public static let SemanticTypographyLineHeightTitleTitle2LineHeight = 19.8
    /** This variable is used in the quote text style line height parameter. */
    public static let SemanticTypographyLineHeightQuoteQuoteLineHeight = 18
    ...
    public static let ComponentArticleArticleKickerFontSize = 22
    /** 40 - 40 - 72 - 100 - This variable uses the semantic variables headline2 for XS&SM, headline1 for MD&LG */
    public static let ComponentArticleArticleHeadlineFontSize = 72
    ...
    public static let ComponentTeaserATeaserATeaserKickerFontSize = 22
    ...
    public static let ComponentTeaserMQTeaserMQTeaserHeadlineFontSize = 36
    ...
    public static let ComponentTeaserQTeaserQuadHeadlineFontSize = 72
