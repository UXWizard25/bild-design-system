...
public class BreakpointAdvertorialMd {
...
Apply this token to the main frame of page layouts to simulate realistic maximum widths across responsive viewports. */
    ...
    public static let SemanticTypographyFontSizeDisplayDisplay1FontSize = 70
    /** This variable is used for the font size parameter of the Display2 text style. 36 - 36 - 42 - 64 */
    public static let SemanticTypographyFontSizeDisplayDisplay2FontSize = 41
    /** This variable is used on the display3 font size parameter of the display3 text style. 28 - 28 - 32 - 40 */
    public static let SemanticTypographyFontSizeDisplayDisplay3FontSize = 31
    ...
    public static let SemanticTypographyFontSizeHeadlineHeadline1FontSize = 54
    /** This token is used on the headline2 text style's font size parameter. 40 - 40 - 48 - 64 */
    public static let SemanticTypographyFontSizeHeadlineHeadline2FontSize = 36
    /** This token is used on the headline3 text style's font size parameter. 28 - 28 - 36 - 40 */
    public static let SemanticTypographyFontSizeHeadlineHeadline3FontSize = 26
    /** This token controls the headline4 text style's font size parameter: 22 - 22 - 26 - 32 */
    public static let SemanticTypographyFontSizeHeadlineHeadline4FontSize = 20
    ...
    public static let SemanticTypographyLineHeightTitleTitle2LineHeight = 19.2
    ...
    public static let ComponentArticleArticleHeadlineFontSize = 54
    ...
    public static let ComponentTeaserATeaserATeaserKickerFontSize = 18
    ...
    public static let ComponentTeaserATeaserATeaserHeadlineFontSize = 36
    ...
    public static let ComponentTeaserMQTeaserMQTeaserHeadlineFontSize = 26
    ...
    public static let ComponentTeaserQTeaserQuadHeadlineFontSize = 54
