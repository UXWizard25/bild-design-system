...
class ColorSportbildLight {
    ColorSportbildLight._();
    ...
    static const semanticCoreCorecolorprimary = Color(0xFF0a264f);
    /** Defines the secondary brand tone. This variable changes across Light and Dark Mode. */
    static const semanticCoreCorecolorsecondary = Color(0xFFffffff);
    /** Represents tertiary brand accents. This variable changes across Light and Dark Mode. */
    static const semanticCoreCorecolortertiary = Color(0xFF081729);
    ...
    static const semanticCoreCorecolortertiaryconstant = Color(0xFF081729);
    /** this is a test for the token pipeline */
    static const semanticCoreCorecolortertiaryvvpipetest = Color(0xFF476e94);
    /** this is a test for the token pipeline */
    static const semanticCoreNpmtest = Color(0xFF476e94);
    /** this is a test for the token pipeline */
    static const semanticCoreFelipetestcolor = Color(0xFFe8570a);
    ...
    static const semanticAttentionAccentcolorprimary = Color(0xFF174582);
    ...
    static const semanticAttentionAccentcolorprimaryconstant = Color(0xFF174582);
    ...
    static const semanticAttentionAttentioncolorextralow = Color(0xFFffffff);
...
Dynamic — light gray in Light mode, dark gray in Dark mode. */
    static const semanticBorderBordercolorlowcontrast = Color(0xFFe8edf0);
...
Behavior: Dynamic — adjusts to maintain legibility in Light and Dark themes. */
    static const semanticBorderBordercolormediumcontrast = Color(0xFFcfd4d9);
...
Behavior: Dynamic — light surfaces use a darker neutral, dark surfaces a light neutral tone. */
    static const semanticBorderBordercolorhighcontrast = Color(0xFF242629);
...
Behavior: Constant — retains the same red warning tone in both Light and Dark modes. */
    ...
    static const semanticBorderBordercolorprimarydisabled = Color(0xFFf2f5f5);
    /** Used for secondary component borders in a disabled state (e.g., secondary buttons, inactive input outlines). */
    static const semanticBorderBordercolorsecondarydisabled = Color(0xFFe8edf0);
    /** Primary icon color on primary surfaces. */
    static const semanticIconIconcolorprimary = Color(0xFF4a5259);
...
Behavior: Dynamic — switches between light and dark. */
    static const semanticIconIconcolorinverse = Color(0xFFcfd4d9);
...
Behavior: Constant — identical value across modes for consistent interaction feedback. */
    static const semanticStateColorprimaryactive = Color(0xFF174582);
...
Behavior: Dynamic — light gray in Light mode and bright gray in Dark mode to maintain perceptual balance. */
    static const semanticStateColorsecondaryactive = Color(0xFF242629);
...
Behavior: Dynamic — switches between bright and dark tones depending on the background. */
    static const semanticStateColorsecondaryactiveinverse = Color(0xFFf2f5f5);
...
Behavior: Dynamic — slightly lighter in Light mode and darker in Dark mode to remain visually accessible. */
    static const semanticStateColorprimarydisabled = Color(0xFFf2f5f5);
...
Behavior: Dynamic — adapts neutral tones based on theme brightness. */
    static const semanticStateColorsecondarydisabled = Color(0xFFe8edf0);
...
Behavior: Dynamic — adjusts between gray tones for Light and Dark mode consistency. */
    static const semanticStateColortertiarydisabled = Color(0xFF8c9196);
...
Behavior: Dynamic — adapts between light and dark surface tokens to maintain legibility and hierarchy. */
    static const semanticSurfaceSurfacecolorprimary = Color(0xFFffffff);
...
Behavior: Dynamic — switches between dark and light values depending on mode. */
    static const semanticSurfaceSurfacecolorprimaryinverse = Color(0xFF081729);
...
Behavior: Constant — identical across Light and Dark mode. */
    static const semanticSurfaceSurfacecolorprimaryconstantdark = Color(0xFF081729);
...
Behavior: Dynamic — adapts brightness level based on mode for appropriate depth contrast. */
    static const semanticSurfaceSurfacecolorsecondary = Color(0xFFf7fafc);
...
Behavior: Dynamic — switches between light and dark tertiary tones. */
    static const semanticSurfaceSurfacecolortertiary = Color(0xFFbdc9db);
...
Behavior: Dynamic — swaps values between modes for contrast preservation. */
    static const semanticSurfaceSurfacecolortertiaryinverse = Color(0xFF174582);
    ...
    static const semanticSurfaceSurfacecolorquartenary = Color(0xFFcfd4d9);
...
Behavior: Dynamic — inverts between dark and light tones depending on mode. */
    static const semanticSurfaceSurfacecolorquartenaryinverse = Color(0xFF4a5259);
...
Behavior: Constant — remains the same across Light and Dark mode to ensure brand alignment. */
    ...
    static const semanticSurfaceSurfacecolorprimarygradientstop = Color(0x00ffffff);
...
Behavior: Dynamic — adapts to mode brightness for smooth gradient transitions. */
    static const semanticSurfaceSurfacecolorsecondarygradientstop = Color(0x00f2f5f5);
    /** Represents tertiary-level gradient background.
Currently used on skeletons. */
    static const semanticSurfaceSurfacecolortertiarygradientstop = Color(0x00e8edf0);
...
Behavior: Dynamic — dark text in Light mode, light text in Dark mode. */
    static const semanticHeadingHeadlinecolorprimary = Color(0xFF0a264f);
...
Behavior: Dynamic — switches between dark text on light backgrounds and light text on dark backgrounds. */
    static const semanticTextTextcolorprimary = Color(0xFF242629);
...
Behavior: Dynamic — alternates between light and dark mode. */
    static const semanticTextTextcolorprimaryinverse = Color(0xFFe8edf0);
...
Behavior: Dynamic — adjusts between mid-gray in Light mode and lighter gray in Dark mode. */
    static const semanticTextTextcolormuted = Color(0xFF666b70);
...
Behavior: Constant — always light neutral to guarantee accessibility on dark backgrounds. */
    ...
    static const semanticTextTextcoloraccent = Color(0xFF174582);
...
Behavior: Constant — maintains identical red tone across Light and Dark mode. */
    static const semanticTextTextcoloraccentconstant = Color(0xFF174582);
...
Behavior: Dynamic — dark neutral in Light mode, light neutral in Dark mode. */
    static const semanticLabelLabelcolorprimary = Color(0xFF242629);
    /** Inverse version of the primary label color, used on dark or colored backgrounds.
Behavior: Dynamic — switches between light and dark. */
    static const semanticLabelLabelcolorprimaryinverse = Color(0xFFe8edf0);
...
Behavior: Dynamic — adapts between mid-grays for Light and Dark surfaces. */
    static const semanticLabelLabelcolorsecondary = Color(0xFF4a5259);
...
Behavior: Dynamic — lighter gray in Light mode, darker neutral in Dark mode. */
    static const semanticLabelLabelcolordisabled = Color(0xFFcfd4d9);
    ...
    static const componentAlertAlertsurfacecolor = Color(0xFFffffff);
    ...
    static const componentBreadcrumbBreadcrumbtextcoloridle = Color(0xFF4a5259);
    ...
    static const componentBreadcrumbBreadcrumbtextcolorhover = Color(0xFF242629);
    ...
    static const componentButtonPrimaryButtonprimaryneutralbgcoloridle = Color(0xFF242629);
    ...
    static const componentHeyHeyseparatorcolor = Color(0xFFcfd4d9);
    ...
    static const componentMenuMenuscrolledsurfacegradientcolor = Color(0xf2ffffff);
    ...
    static const componentPartnerlinksPartnerlinksbgcoloridle = Color(0xFFffffff);
    /** !do not use! these variables have been deprecated and multitext link buttons are now classified as partner buttons. */
    static const componentPartnerlinksPartnerlinksbgcoloractive = Color(0xFFe8edf0);
    /** !do not use! these variables have been deprecated and multitext link buttons are now classified as partner buttons. */
    static const componentPartnerlinksPartnerlinksbordercoloridle = Color(0xFFcfd4d9);
    /** !do not use! these variables have been deprecated and multitext link buttons are now classified as partner buttons. */
    static const componentPartnerlinksPartnerlinksbordercoloractive = Color(0xFF242629);
    /** !do not use! these variables have been deprecated and multitext link buttons are now classified as partner buttons. */
    static const componentPartnerlinksPartnerlinkscontainerbordercolor = Color(0xFFcfd4d9);
    ...
    static const componentPaginationScrollbartrackbgcolor = Color(0x1a000000);
    ...
    static const componentSelectionSelectionbordercolor = Color(0xFF4a5259);
    ...
    static const component_dsysdocDsdocspacingitembgcolor = Color(0x1ade0000);
    static const component_dsysdocDsdocspacingitembordercolor = Color(0x80de0000);
    /** This variable is only for use in Figma's Design System File. It is automating some of the content in documentation pages. */
    static const component_dsysdoc_dsysdocs_labeltextsurfacecolorprimaryprimitivename = "BILD100";
    ...
    static const component_dsysdoc_dsysdocs_labeltextcolormode = "(Light Mode)";
}
