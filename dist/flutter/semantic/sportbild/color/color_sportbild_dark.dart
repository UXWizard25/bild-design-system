...
class ColorSportbildDark {
    ColorSportbildDark._();
    ...
    static const semanticCoreCorecolorsecondary = Color(0xFF081729);
    ...
    static const semanticAttentionAccentcolorprimary = Color(0xFFf7fafc);
...
Behavior: Dynamic — adapts between light and dark surface tokens to maintain legibility and hierarchy. */
    static const semanticSurfaceSurfacecolorprimary = Color(0xFF081729);
...
Behavior: Dynamic — adapts brightness level based on mode for appropriate depth contrast. */
    static const semanticSurfaceSurfacecolorsecondary = Color(0xFF0a264f);
...
Behavior: Dynamic — switches between light and dark tertiary tones. */
    static const semanticSurfaceSurfacecolortertiary = Color(0xFF174582);
...
Behavior: Dynamic — swaps values between modes for contrast preservation. */
    static const semanticSurfaceSurfacecolortertiaryinverse = Color(0xFFbdc9db);
...
Behavior: Constant — always light neutral to guarantee accessibility on dark backgrounds. */
    ...
    static const semanticTextTextcoloraccent = Color(0xFFf7fafc);
...
Behavior: Dynamic — lighter gray in Light mode, darker neutral in Dark mode. */
    ...
    static const componentAvatarAvatarlabelcolor = Color(0xFFe8edf0);
    /** 09-2025 css --article-author-name-color */
