...
class BreakpointAdvertorialSm {
    BreakpointAdvertorialSm._();
...
Apply this token to the main frame of page layouts. */
    static const semanticLayoutCanvaswidthsizeweb = 390;
...
Apply this token to the main frame of page layouts to simulate realistic vertical space. */
    static const semanticLayoutCanvasheightsizeweb = 844;
    /** Common viewport width size based on the selected breakpoint.
Apply this token to the main frame of page layouts. */
    static const semanticLayoutCanvaswidthsizeapp = 390;
    /** Common viewport height size based on the selected mode.
Apply this token to the main frame of page layouts to simulate realistic vertical space. */
    static const semanticLayoutCanvasheightsizeapp = 844;
...
Apply this token to the main frame of page layouts to simulate realistic minimum widths across responsive viewports. */
    static const semanticLayoutBreakpointsBreakpointminwidthsize = 390;
...
Apply this token to the main frame of page layouts to simulate realistic maximum widths across responsive viewports. */
    static const semanticLayoutBreakpointsBreakpointmaxwidthsize = 599;
    ...
    static const semanticTypographyFontsizeCalloutCallout1fontsize = 16;
    /** This variable is used on the font size parameter for the display1 text style. 40 - 40 - 72 - 120 */
    static const semanticTypographyFontsizeDisplayDisplay1fontsize = 39;
    /** This variable is used for the font size parameter of the Display2 text style. 36 - 36 - 42 - 64 */
    static const semanticTypographyFontsizeDisplayDisplay2fontsize = 35;
    ...
    static const semanticTypographyFontsizeHeadlineHeadline1fontsize = 36;
    /** This token is used on the headline2 text style's font size parameter. 40 - 40 - 48 - 64 */
    static const semanticTypographyFontsizeHeadlineHeadline2fontsize = 30;
    /** This token is used on the headline3 text style's font size parameter. 28 - 28 - 36 - 40 */
    static const semanticTypographyFontsizeHeadlineHeadline3fontsize = 24;
    /** This token controls the headline4 text style's font size parameter: 22 - 22 - 26 - 32 */
    static const semanticTypographyFontsizeHeadlineHeadline4fontsize = 16;
    ...
    static const semanticTypographyFontsizeKickerKicker1fontsize = 16;
    ...
    static const semanticTypographyFontsizeKickerKicker4fontsize = 12;
    ...
    static const semanticTypographyFontsizeTitleTitle2fontsize = 14;
    ...
    static const componentArticleArticlekickerfontsize = 16;
    /** 40 - 40 - 72 - 100 - This variable uses the semantic variables headline2 for XS&SM, headline1 for MD&LG */
    static const componentArticleArticleheadlinefontsize = 30;
    ...
    /** Tab labels font size remain constant at 16px across devices and breakpoints. This behavior can be seen on the Mein Konto page tabs for purchases and payment data. */
    static const componentTabsAppstabslabelfontsize = 12;
    /** Tab labels font size remain constant at 16px across devices and breakpoints. This behavior can be seen on the Mein Konto page tabs for purchases and payment data. */
    ...
    static const componentTeaserAteaserAteaserkickerfontsize = 14;
    ...
    static const componentTeaserAteaserAteaserheadlinefontsize = 24;
    ...
    static const componentTeaserMqteaserMqteaserheadlinefontsize = 16;
    ...
    static const componentTeaserQteaserQuadheadlinefontsize = 36;
    ...
    static const component_dsysdocsDsysdocswidthsize = 750;
    ...
    static const component_dsysdocsMaincontentstagesize = 750;
