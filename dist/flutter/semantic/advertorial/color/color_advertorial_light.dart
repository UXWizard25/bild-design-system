...
class ColorAdvertorialLight {
    ColorAdvertorialLight._();
    ...
    static const semanticCoreCorecolortertiary = Color(0xFF242629);
    ...
    static const semanticAttentionAccentcolorprimary = Color(0xFFde0000);
...
Behavior: Dynamic — switches between dark and light values depending on mode. */
    static const semanticSurfaceSurfacecolorprimaryinverse = Color(0xFF242629);
...
Behavior: Dynamic — adapts brightness level based on mode for appropriate depth contrast. */
    static const semanticSurfaceSurfacecolorsecondary = Color(0xFFf2f5f5);
...
Behavior: Dynamic — switches between light and dark tertiary tones. */
    static const semanticSurfaceSurfacecolortertiary = Color(0xFFe8edf0);
...
Behavior: Dynamic — swaps values between modes for contrast preservation. */
    static const semanticSurfaceSurfacecolortertiaryinverse = Color(0xFF333d40);
...
Behavior: Dynamic — dark text in Light mode, light text in Dark mode. */
    static const semanticHeadingHeadlinecolorprimary = Color(0xFF242629);
...
Behavior: Dynamic — adjusts between red for Light and a neutral tone in Dark modes. */
    static const semanticHeadingKickertextcoloronsurface = Color(0xFFde0000);
...
Behavior: Constant — always light neutral to guarantee accessibility on dark backgrounds. */
    ...
    static const semanticTextTextcoloraccent = Color(0xFFde0000);
